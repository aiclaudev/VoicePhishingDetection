...
root_urls = []
for i in range(1, 12) :
    root_urls.append(f'https://www.fss.or.kr/fss/bbs/B0000206/list.do?menuNo=200690&bbsId=&cl1Cd=&pageIndex={i}&sdate=&edate=&searchCnd=1&searchWrd=')
#print(root_urls)
for root_url in root_urls :
    ...
    for i in targetURLs :
        ...
        #print(type(t))
        file_url = root + b
        os.chdir('C:/Users/82102/Desktop/Project/LIFLOW/221017/금감원 크롤링/audio/대출사기형')
