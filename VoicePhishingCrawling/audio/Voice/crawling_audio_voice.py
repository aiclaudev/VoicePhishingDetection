...
root_urls = []
for i in range(1, 12) :
    root_urls.append(f'https://www.fss.or.kr/fss/bbs/B0000203/list.do?menuNo=200686&bbsId=&cl1Cd=&pageIndex={i}&sdate=&edate=&searchCnd=1&searchWrd=')
#print(root_urls)
for root_url in root_urls :
    ...
    target_urls = bsObject_root.select(".bd-list-thumb-a")
    #tmp = target_urls.find('a')['href']
    targetURLs = []
    for t in target_urls[0].select('li') :
        targetURLs.append(t.find('a')['href'])
    #print(targetURLs)
    #print(type(bsObject_root))
    #print(type(target_urls))
    #target_urls.find()['href']
    #print(target_urls)
    ...
    for i in targetURLs :
        ...
        t = bsObject.select(".file-list")
        #print(type(t))
        b = t[0].find("a")['href']
        file_url = root + b
        os.chdir('C:/Users/82102/Desktop/Project/LIFLOW/221017/금감원 크롤링/audio/바로 이 목소리')
